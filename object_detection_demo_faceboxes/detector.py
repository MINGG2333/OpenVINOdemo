...
class Detector(object):
    def __init__(self, ie, model_path, device='CPU', threshold=0.5):
        ...
        assert model.outputs[self._output_layer_names[0]].shape[2] == 2, "Expected 4-coordinate boxes"
        assert model.outputs[self._output_layer_names[1]].shape[2] == 4, "Expected 2-class scores(background, face)"
